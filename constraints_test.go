...
func TestConstraintsCheck(t *testing.T) {
	tests := []struct {
		...
		{"<=1.1.0", "1.1.1", false},
		{"<=1.1.x", "1.2.500", false},
		{">1.1.0 <2.0.0", "1.1.1", true},
		{">1.1.0 <3.0.0", "4.3.2", false},
		{">=1.1.0 <2.0.0 !=1.2.3", "1.2.3", false},
		{">=1.1.0 <2.0.0 !=1.2.3 || > 3", "3.1.2", true},
		{">=1.1.0 <2.0.0 !=1.2.3 || >= 3", "3.0.0", true},
		{">=1.1.0 <2.0.0 !=1.2.3 || > 3", "3.0.0", false},
		{">=1.1.0 <2.0.0 !=1.2.3 || > 3", "1.2.3", false},
		{"1.1 - 2", "1.1.1", true},
		{"1.1-3", "4.3.2", false},
		{"^1.1", "1.1.1", true},
		{"^1.1", "4.3.2", false},
...
func TestConstraintsValidate(t *testing.T) {
	tests := []struct {
		...
		{">1.1.0 <3.0.0", "4.3.2", false},
		{">=1.1.0 <2.0.0 !=1.2.3", "1.2.3", false},
		{">=1.1.0 <2.0.0 !=1.2.3 || > 3.0.0", "3.1.2", true},
		{">=1.1.0 <2.0.0 !=1.2.3 || >= 3.0.0", "3.0.0", true},
		{">=1.1.0 <2.0.0 !=1.2.3 || > 3.0.0", "3.0.0", false},
		{">=1.1.0 <2.0.0 !=1.2.3 || > 3.0.0", "1.2.3", false},
		{"1.1 - 2", "1.1.1", true},
		{"1.1-3", "4.3.2", false},
		{"^1.1", "1.1.1", true},
		{"^1.1", "4.3.2", false},
	...
	tests2 := []struct {
		...
		{"= 2.0.0", "1.2.3", "1.2.3 is not equal to 2.0.0"},
		{"!=4.1", "4.1.0", "4.1.0 is equal to 4.1"},
		{"!=4.x", "4.1.0", "4.1.0 is equal to 4.x"},
		{"!=4.2.x", "4.2.3", "4.2.3 is equal to 4.2.x"},
		{">1.1.0", "1.1.0", "1.1.0 is less than or equal to 1.1.0"},
		{"<1.1.0", "1.1.0", "1.1.0 is greater than or equal to 1.1.0"},
		{"<1.1.0", "1.1.1", "1.1.1 is greater than or equal to 1.1.0"},
		{"<1.x", "2.1.1", "2.1.1 is greater than or equal to 1.x"},
		{"<1.1.x", "1.2.1", "1.2.1 is greater than or equal to 1.1.x"},
		{">=1.1.0", "0.0.9", "0.0.9 is less than 1.1.0"},
		{"<=2.x", "3.1.0", "3.1.0 is greater than 2.x"},
		{"<=1.1.0", "1.1.1", "1.1.1 is greater than 1.1.0"},
		{"<=1.1.x", "1.2.500", "1.2.500 is greater than 1.1.x"},
		{">1.1.0 <3.0.0", "4.3.2", "4.3.2 is greater than or equal to 3.0.0"},
